...
const NavigationMenuItems = ({ open, setOpen }) => {
    ...
    return (
        <div className={`nav-menu-list ${revealMenuClass}`} open={open}>
            <ul>
                <Link to="/" onClick={() => togglePaintSubMenu()}><li className="nav-menu-item">Paint</li></Link>
                    {/* add conditional rendering of sub menu items. these are hidden until the Paint item is active */}
                    ...
                    <Link to="/" onClick={() => togglePaperSubMenu()}><li className="nav-menu-item">Paper</li></Link>
                    ...
                    <Link to="/" onClick={() => toggleClaySubMenu()}><li className="nav-menu-item">Clay</li></Link>
                    <ul className={`section-sub-menu ${revealClaySubMenuItems}`}>
                    <Link to="/"><li className="sub-nav-menu-item">Liquid States</li></Link>
                    <Link to="/"><li className="sub-nav-menu-item">Water-Works</li></Link>
                    <Link to="/"><li className="sub-nav-menu-item">Painted Pools</li></Link>
                    </ul>
                <Link to="/video" onClick={() => setOpen(!open)}><li className="nav-menu-item">Video</li></Link>
                <Link to="/news" onClick={() => setOpen(!open)}><li className="nav-menu-item">News</li></Link>
                <Link to="/exhibition" onClick={() => setOpen(!open)}><li className="nav-menu-item">Exhibitions</li></Link>
                <Link to="/biography" onClick={() => setOpen(!open)}><li className="nav-menu-item">Biography</li></Link>
                <Link to="/words" onClick={() => setOpen(!open)}><li className="nav-menu-item">Words</li></Link>
                <Link to="/contact" onClick={() => setOpen(!open)}><li className="nav-menu-item">Contact</li></Link>
            </ul>
        </div>
    )
