...
const Home = () => {
    return( 
        <div className="image-container">
            {/* 1 <img className="individual-image-main" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/backbend.jpg'} alt="Backbend - Lorraine Shemesh"/> */}
            {/* 2 <img className="individual-image-main" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/chrysalis.jpg'} alt="Chrysalis - Lorraine Shemesh"/> */}
