        ...
        <div>
             <div className="image-section">
                ...
                <div className="exhibition-year-group">
                    ...
                    <div className="exhibition-content-right">
                        <div className="exhibition-container">
                            <p className="exhibition-name">Shemesh, Lorraine. <b><a href="https://unruffled-knuth-c3e5aa.netlify.app/">"Hands-On Art."</a></b></p>
                            <p className="exhibition-name"><b>The New Yorker. </b>(August 1, 2011): 5.</p>
                        </div>   
                        <div className="exhibition-container">
                            <p className="exhibition-name">Barrett, Terry. <b><a href="https://unruffled-knuth-c3e5aa.netlify.app/">"Making Art - Form and Meaning."</a></b></p>
            ...
            <div className="exhibition-year-group">
                ...
                <div className="exhibition-content-right">
                    ...
                    <div className="exhibition-container">
                        <p className="exhibition-name"><b><a href="https://unruffled-knuth-c3e5aa.netlify.app/">The Collector</a></b>. Directed by Olympia Stone. 2007.</p>
                    </div>  
                    <div className="exhibition-container">
            ...
            <div className="exhibition-year-group">
                ...
                <div className="exhibition-content-right">
                    ...
                    <div className="exhibition-container">
                        <p className="exhibition-name">Kennedy, Patrick, <b><a href="https://unruffled-knuth-c3e5aa.netlify.app/">"Seeing the Extraordinary in the Ordinary."</a></b></p>
