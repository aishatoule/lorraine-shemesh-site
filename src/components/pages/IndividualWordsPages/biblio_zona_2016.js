    ...
    return (
        <div>
            <div className="image-section">
                <img className="exhibition-image" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/studio_201904c.jpg'} alt="exhibition"/>
            </div>
            <div className="individual-words-paragraph-container">
                ...
                <h4 className="individual-words-paragraph">Her current work logically extends her studied underwater theme. She has moved the human form into a world of color and form recalling Picasso's Saltimbanques from his Rose period. Lorraine Shemesh's figures are positioned within color rich composition, literally one with formal elements. Her 2017 painting, Hinge, of a dancer with white face paint reclining within an optical field of tan and white shapes is a work so accomplished as to be able to share a wall with the great Picasso.</h4>
                <h4 className="individual-words-paragraph">In her work The Space Between Us from 2015, two figures are positioned to challenge all notions of pictorial space. The Albers-like geometry is juxtaposed by silver clad figures in a composition of visual give and take.</h4>
                <h4 className="individual-words-paragraph">A favorite work is Interlock, 2017, where primaries in box-form create a sense of space both deep and shallow. The embracing figures provide a psychological, if not visual human warming. A very recent work, Accordion, is Baroque in nature with its dramatic sense of light and circular chasing forms.</h4>
                <h4 className="individual-words-paragraph">Riddle, 2018, is a virtual clinic on technique. Lorraine Shemesh is a master draughtsman who knows how to build a successful painting through the subtle build-up of line and texture independent of color. Riddle, where dancer meets athlete vibrates with visual effects. Values are also at work, energizing and help in the definition of space. Attached, 2018, again presents two figures ablaze with warm tones—and with multiple light sources that even harken back to the drama of Carravaggio-like light and shadow. This is a master work in which color explodes and where a center white light washes the figures, creating mystifying shadow effects that seemingly at once push the figure frontally and then look like Hans Hoffman's push-pull theories.</h4>
