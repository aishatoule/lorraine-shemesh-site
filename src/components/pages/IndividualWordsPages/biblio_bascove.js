...
const biblio_bascove = () => {
    return (
        <div>
            <div className="image-section-bascove">
                <img className="individual-words-top-image" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/paint-io/tilt_Em201604_Tilt_painting_v1.jpg'} alt="Tilt"/>
                <h4><i><b>“Tilt”, 2015, Oil on canvas, 59 1/4″ x 63 1/4″</b></i></h4>
            </div>
            <div className="individual-words-paragraph-container">
                ...
                <div className="horizontal-image-set-container">
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/paint-io/spots_CD25_1b_8.jpg'} alt="Spots" />
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/paint-io/spots_CD25_1b_8.jpg'} alt="Spots" />
                </div>
                <h4><i><b>“Spots”, 2012, oil on canvas, 65″ x 63″</b></i></h4>
                ...
                <img className="individual-words-image-horizontal" src={'   https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/clay-hb/blackwhitetiltednervess.jpg'} alt="Black & White Titled Vessel" />
                <h4><i><b>“Black & White Titled Vessel”, 2011. porcelain 4 1/2″ x 11″ x7 1/2”</b></i></h4>
                <div className="horizontal-image-set-container">
                ...
                <h4><i><b>“Blue & White Swirl Vessel”, 2015. porcelain 6 3/4″ x 5 1/2″ x5 1/2”</b></i></h4>
                ...
                <div className="horizontal-image-set-container">
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/clay-hb/smcheckedblackwhitenercyl.jpg'} alt="Small Checked Black & White Cylinder" />
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/clay-hb/smcheckedblackwhitenercyl.jpg'} alt="Small Checked Black & White Cylinder" />
                </div>
                <h4><i><b>“Small Checked Black & White Cylinder”, 2015. Porcelain 5 1/8″ x 5″ x5”</b></i></h4>
                ...
                <div className="horizontal-image-set-container">
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/paint-io/crescent_CD26_03_0.jpg'} alt="Crescent" />
                    <img className="individual-words-image-vertical-two" src={'https://lorraineshemeshsiteimgs.s3.us-east-2.amazonaws.com/paint-io/crescent_CD26_03_0.jpg'} alt="Crescent" />
                </div>
                <h4><i><b>“Crescent”, 2013, oil on canvas, 75″ x 48 3/4″</b></i></h4>
                ...
                <div className="individual-words-text-container">
                    <p className="individual-words-closing-text">May 7th – June 2nd, 2016</p>
                    <p className="individual-words-closing-text"></p>
                    <p className="individual-words-closing-text">GP Contemporary</p>
                    <p className="individual-words-closing-text">Gerald Peters Gallery</p>
                    <p className="individual-words-closing-text">24 East 78th Street</p>
                    <p className="individual-words-closing-text">New York NY 10075</p>
                    <p className="individual-words-closing-text">212-628-9760</p>
                </div>
                <div className="individual-words-text-container">
                    <p className="individual-words-closing-text">Writing by Bascove</p>
                    <p className="individual-words-closing-text">By A. Bascove | May 9th, 2016 | New York, Reviews and Photo Stories</p>                  
                </div>
            </div>
        </div>
    )
