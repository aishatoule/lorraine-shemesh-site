...
class Exhibition_insideout extends Component {
            ...
            {imageColumn.map((image, index) => {
                return (
                    ...
                    <Link key={index} location={this.props.location} to={{
                        ...
                        <img key={index} src={image[0].name} className="grid-image" alt="Inside Out exhibition, Gerald Peters Gallery, New York"/>
                    </Link>
                )                    
            })}
            </div>
