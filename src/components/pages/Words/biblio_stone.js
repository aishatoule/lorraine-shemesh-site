    ...
    return (
        <div>
            ...
            <div className="individual-words-paragraph-container">
                ...
                <h4 className="individual-words-paragraph">Viewed from a distance, Shemesh’s paintings are classical, figurative compositions. However, when one investigates Shemesh’s paintings up close, one discovers an extraordinary network of abstract compositions. The swimmer, the pool, and the water are formats that allow Shemesh to create a rich confection of color, texture, and light which stands on its own without needing a narrative format. Like any Pollock or de Kooning surface, Shemesh’s surfaces in <NavLink to="/ls1" className="words-link">Zig-Zag</NavLink>, 2003 and <NavLink to="/biblio_stone_pool_image" className="words-link">Propeller</NavLink>, 2002 are rich and dense.</h4>
                ...
                <h4 className="individual-words-paragraph">Shemesh is also influenced by Thiebaud’s sensuous celebration of paint. In her early work, Shemesh shows compositional and color influences of Thiebaud as well as subject-matter influence in her, <NavLink to="/biblio_stone_cakes" className="words-link">Cakes</NavLink>, <NavLink to="/biblio_stone_pastries" className="words-link">Pastries</NavLink>, <NavLink to="/biblio_stone_donuts" className="words-link">Donuts</NavLink>, and <NavLink to="/biblio_stone_bagels_and_lox" className="words-link">Bagels and Lox</NavLink>, paintings. Like many painters, these influences become points of departure from which the artist pushes on to discover her own painting personality.</h4>
