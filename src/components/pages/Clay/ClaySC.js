...
class ClaySC extends Component {
    ...
    let mappedDesktopImages = allImagesDesktopOrderClaySC.map((imageColumn, i) => {
        return(
    ...
    let mappedMobileImages = allImagesMobileOrderClaySC.map((imageColumn, i) => {
        return(
            <div key={i} className="column">
            {imageColumn.map((image, index) => {
                return (
