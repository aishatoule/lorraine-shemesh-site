...
class ClayHB extends Component {
    ...
    let mappedDesktopImages = allImagesDesktopOrderClayHB.map((imageColumn, i) => {
        return(
    ...
    let mappedMobileImages = allImagesMobileOrderClayHB.map((imageColumn, i) => {
        return(
            <div key={i} className="column">
            {imageColumn.map((image, index) => {
                return (
