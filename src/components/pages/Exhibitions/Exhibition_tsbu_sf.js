...
class Exhibition_tbsu_sf extends Component {
    ...
    let mappedDesktopImages = allImagesDesktopOrderExhTBSUSF.map((imageColumn, i) => {
        return(
    ...
    let mappedMobileImages = allImagesMobileOrderExhTBSUSF.map((imageColumn, i) => {
        return(
            <div key={i} className="column">
            {imageColumn.map((image, index) => {
                return (
